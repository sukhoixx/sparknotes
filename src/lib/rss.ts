...
export const FEEDS: Record<Category, { url: string; source: string }[]> = {
  ...
  military: [
    ...
    { url: "https://www.marinecorpstimes.com/arc/outboundfeeds/rss/", source: "Marine Corps Times" },
    ...
    { url: "https://smallwarsjournal.com/blog/feed",                  source: "Small Wars Journal" },
  ],
  science: [
  ...
  sports: [
    ...
    { url: "https://www.sbnation.com/rss/current",                  source: "SB Nation" },
    { url: "https://www.sportingnews.com/us/rss",                   source: "Sporting News" },
    { url: "https://deadspin.com/rss",                              source: "Deadspin" },
    { url: "https://rssfeeds.usatoday.com/UsatodaySports-TopStories", source: "USA Today Sports" },
