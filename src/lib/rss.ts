...
const FEEDS: Record<Category, { url: string; source: string }[]> = {
  ...
  world: [
    ...
    { url: "https://www.voanews.com/api/zquygvm-ypeq",                source: "VOA News" },
    ...
    { url: "https://www.lowyinstitute.org/the-interpreter/rss",        source: "Lowy Institute" },
  ],
  us: [
  ...
  sports: [
    ...
    { url: "https://www.nfl.com/rss/rsslanding.html",               source: "NFL.com" },
  ],
  business: [
